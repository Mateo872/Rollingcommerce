...
export function dataValidate(title, description, characteristics, image, imagePreviewOne, imagePreviewTwo, imagePreviewThree, category, price, stock){
    ...
    if(!characters(title, 3, 100)){
        data += 'Corregir la cantidad de caracteres, el titulo debe contener entre 3 y 100 caracteres. <br>';
    }
    if(!characters(description, 3, 600)){
        data += 'Corregir la cantidad de caracteress, la descripción debe contener entre 3 y 600 caracteres.<br>'
    }
    if(!characters(characteristics, 3, 600)){
        data += 'Corregir la cantidad de caracteres, Las características deben contener entre 3 y 100 caracteres.<br>'
    }
